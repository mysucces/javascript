...
// SHOW THE CBT PROGRESS
 ...
 function showProgress(){
    /*let currentQuestionNum= Math.floor(Math.random()*myCbt.questions.length);*/
    ...
    function showScores(){
    let cbtEndHtml =`<h1 class="end">cbt question completed</h1>
                    <h2 id = "score">You scored : ${myCbt.score} of  ${myCbt.questions.length}</h2>
